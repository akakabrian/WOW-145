...
import WOW145.ExceptionalConstruction

/-!
# Direct exceptional case for WOWII Conjecture 145

The theorem is proved directly from natural-valued radius two, diameter four,
and peripheral-set eccentricity three.  No graph square and no Conjecture 146
module is imported.
-/
...
/-- In the extremal radius-two, diameter-four, periphery-eccentricity-three
configuration, the graph has an induced tree on at least six vertices. -/
theorem exceptional_case
  ...
  obtain ⟨c, hc⟩ := exists_center_dist_le_two_of_radius_eq_two G hG hr
